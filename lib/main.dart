...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return MaterialApp(
      ...
      initialRoute: '/',
      routes: {
        '/': (context) => const Directionality(textDirection: TextDirection.rtl, child: InputPage()),
        '/records': (context) => const Directionality(textDirection: TextDirection.rtl, child: RecordsPage()),
      },
